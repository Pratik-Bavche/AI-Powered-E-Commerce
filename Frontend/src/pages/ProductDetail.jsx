        ...
        <div className="lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]">
          ...
          <div className="flex gap-2">
            {productData.sizes.map((item, index) => (
              <button
                key={index}
                className={`border py-2 cursor-pointer px-4 bg-slate-300 rounded-md ${
          ...
          <button
            className="text-[16px] active:bg-slate-500 cursor-pointer bg-[#495b61c9] py-[12px] px-[50px] rounded-2xl mt-[10px] border-[1px] border-[#80808049] text-white shadow-md shadow-black"
            onClick={() => addtoCart(productData._id, size)}
          >
            Add To Cart
          </button>

          <div className="w-[90%] h-[1px] bg-slate-700 mt-4 hidden md:block"></div>
          <div className="w-[80%] text-[16px] text-white hidden md:block">
