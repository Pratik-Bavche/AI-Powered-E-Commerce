      ...
      <div className="max-w-[600px] w-[90%] min-h-[500px] py-4 bg-[#00000025] border-[1px] border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center">
        ...
        >
          ...
          <div
            ...
            onClick={googleLogin}
          >
            <img src={google} alt="Google Icon" className="w-[20px]" /> Sign in
            with Google
          </div>
          ...
          <div className="w-[90%] flex flex-col items-center justify-center gap-[15px]">
            ...
            <button
              type="submit"
              className="w-[100%] h-[50px] cursor-pointer bg-[#6060f5] rounded-lg flex items-center justify-center mt-[20px] text-[17px] font-semibold"
            >
              Login
            </button>
